...
specification. It follows the dependency order surfaced in
`.planning/codebase/CONCERNS.md` and the existing `TODO.md` milestone
breakdown: first clear the flagged architecture/tech-debt blockers (Phase 1),
then fix the *process* gap that would otherwise stall concept review (Phase 2),
...
- [ ] **Phase 1: Concerns Remediation** - Fill the four empty architecture specs and resolve the tech-debt items flagged in CONCERNS.md
- [ ] **Phase 2: Foundations, Process & Vision** - Define the concept acceptance gate, review process, and requirement-tracking model; review the Why-layer documents (Manifesto, Vision, Zen)
...
**Success Criteria** (what must be TRUE):
  ...
  3. A template-compliance audit checklist for the 8-section `_concept.md` template exists and is referenced from the Concept Design Review process doc, so Phase 3's review gate has a concrete checklist to apply.
...
|-------|-----------------|--------|-----------|
| 1. Concerns Remediation | 0/TBD | Not started | - |
| 2. Foundations, Process & Vision | 0/TBD | Not started | - |
