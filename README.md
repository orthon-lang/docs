...
* [Core Concepts](what/CORE_CONCEPTS.md) — фундаментальные сущности языка (Data, Data Modifiers, Function, Sequence, Reference, ...).
* [Orthon Data Model](what/DATA_MODEL.md) - уже конкретная модель данных: Value, Tuple, Reference, Sequence, Set, Option, Result и операции над ними.
